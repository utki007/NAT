...
class Voice_config(View):
    ...
    async def update_embed(self, interaction: discord.Interaction, data: dict):
        embed = discord.Embed(color=3092790, title="Private Voice")
    ...
    @button(
        label="Toggle", style=discord.ButtonStyle.gray, custom_id="vc:toggle", row=1
    )
    ...
    async def channel(self, interaction: discord.Interaction, button: Button):
        ...
        view.select = Channel_select(
            placeholder="Select new to join to create voice channels",
            max_values=1,
            min_values=1,
        ...
        if self.data["join_create"] == channel.id:
            ...
            await view.select.interaction.response.edit_message(
                content="Removed the channel", embed=None, view=None
            )
        else:
            self.data["join_create"] = channel.id
            await view.select.interaction.response.edit_message(
                content=f"Updated the channel to {channel.mention}",
                embed=None,
                view=None,
            )
...
class Voice_UI(View):
    ...
    async def lock(self, interaction: discord.Interaction, button: Button):
        ...
        if not data:
            return await interaction.response.send_message(
                "This voice channel is not registered", ephemeral=True, delete_after=5
            )
        ...
        await interaction.response.send_message(
            "Locked the voice channel", ephemeral=True, delete_after=5
        )
    ...
    async def unlock(self, interaction: discord.Interaction, button: Button):
        ...
        await interaction.response.send_message(
            "Unlocked the voice channel", ephemeral=True, delete_after=5
        )

    @button(
        label="Hide",
        style=discord.ButtonStyle.gray,
        emoji="<:Hide:1132021554188931102>",
        row=0,
        custom_id="vc:hide",
    )
    async def hide(self, interaction: discord.Interaction, button: Button):
        ...
        await interaction.response.send_message(
            "Hided the voice channel", ephemeral=True, delete_after=5
        )

    @button(
        label="Unhide",
        style=discord.ButtonStyle.gray,
        emoji="<:Unhide:1132021407543459941>",
        row=0,
        custom_id="vc:unhide",
    )
    async def unhide(self, interaction: discord.Interaction, button: Button):
        ...
        await interaction.response.send_message(
            "Unhided the voice channel", ephemeral=True, delete_after=5
        )

    @button(
        label="Add/Remove Friend",
        style=discord.ButtonStyle.gray,
        emoji="<:tgk_person_add:1132022878288744598>",
        row=1,
        custom_id="vc:add_friend",
    )
    async def add_friend(self, interaction: discord.Interaction, button: Button):
        ...
        view.select = User_Select(
            placeholder="Select friends you want to add/remove",
            max_values=10,
            min_values=1,
        )
        view.add_item(view.select)
    ...
    @button(
        label="Set Limit",
        style=discord.ButtonStyle.gray,
        emoji="<:tgk_limit:1132030665672626359>",
        row=1,
        custom_id="vc:set_limit",
    )
    async def set_limit(self, interaction: discord.Interaction, button: Button):
        ...
        modal.value = None
        modal.limit = TextInput(
            label="New Limit",
            placeholder="Enter the limit of the voice channel",
            default=interaction.channel.user_limit,
        )
        ...
        try:
            ...
            return await modal.interaction.response.send_message(
                "Please enter a valid number", ephemeral=True, delete_after=5
            )
        if limit >= 100:
            await interaction.channel.edit(user_limit=None)
            await modal.interaction.response.send_message(
                "Removed the limit of the voice channel", ephemeral=True, delete_after=5
            )
        else:
            await interaction.channel.edit(user_limit=limit)
            await modal.interaction.response.send_message(
                f"Set the limit of the voice channel to {limit}",
                ephemeral=True,
                delete_after=5,
            )
    ...
    @button(
        label="Set Bitrate",
        style=discord.ButtonStyle.gray,
        emoji="<:tgk_bitrate:1132034718603431976> ",
        row=1,
        custom_id="vc:set_bitrate",
    )
    async def set_bitrate(self, interaction: discord.Interaction, button: Button):
        ...
        modal.value = None
        modal.bitrate = TextInput(
            label="New Bitrate",
            placeholder="Enter the bitrate of the voice channel",
            default=f"{int(round(interaction.channel.bitrate)/1000)}",
        )
        ...
        if bitrate < 8000 or bitrate > 96000:
            return await modal.interaction.response.send_message(
                "Please enter a valid from 8 to 96", ephemeral=True, delete_after=5
            )
        await interaction.channel.edit(bitrate=bitrate)
        await modal.interaction.response.send_message(
            f"Set the bitrate of the voice channel to {int(bitrate/1000)} Kbps",
            ephemeral=True,
            delete_after=5,
        )
    ...
    @button(
        label="Set Name",
        style=discord.ButtonStyle.gray,
        emoji="<:tgk_edit:1132037251757510666>",
        row=2,
        custom_id="vc:set_name",
    )
    async def set_name(self, interaction: discord.Interaction, button: Button):
        ...
        modal.name = TextInput(
            label="New Name",
            placeholder="Enter the name of the voice channel",
            default=interaction.channel.name,
        )
        ...
        await modal.interaction.response.send_message(
            f"Set the name of the voice channel to {modal.name.value}",
            ephemeral=True,
            delete_after=5,
        )
    ...
    @button(
        ...
        emoji="<:tgk_delete:1132040126478950400>",
        row=2,
        custom_id="vc:delete",
    )
    async def delete(self, interaction: discord.Interaction, button: Button):
        ...
        await interaction.response.send_message(
            "Are you sure you want to delete this voice channel?", view=view
        )
        ...
        await view.interaction.response.edit_message(
            content="Deleting the voice channel...", view=None
        )
