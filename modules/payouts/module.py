...
class PayoutV2(commands.GroupCog, name="payout"):
    ...
    async def payout_create(self, interaction: discord.Interaction, event: str, message_id: app_commands.Transform[discord.Message, MessageConverter], winners: app_commands.Transform[discord.Member, MultipleMember], quantity: app_commands.Transform[int, DMCConverter], item: str=None):
                    ...
                    match payout_message.content.lower():
                        ...
                        case "reject":
                            ...
                            if reject is True:
                                ...
                                break
                        case "exit":
                            await interaction.followup.send("Stopped the payout queue", ephemeral=True)
