...
async def set_cric_reminder(bot, message, remind_at: datetime.datetime, user: discord.Member, type , send_message: bool = True):
    ...
    if data is None:
        ...
        data['time'] = remind_at
        data['message'] = f'https://discord.com/channels/{message.guild.id}/{message.channel.id}'
